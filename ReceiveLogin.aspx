<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReceiveLogin.aspx.cs" Inherits="ReceiveLogin" %>
...
<div class="bg-image" 
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    Password:<asp:TextBox ID="TextBox2" runat="server"></asp:TextBox><br />
        ...
        <asp:Button ID="Button1" runat="server" Text="New User" onclick="Button2_Click" /><br />
    </div>
    </form>
    </div>
</body>
